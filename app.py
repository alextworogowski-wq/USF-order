...
chicken_freezer = st.selectbox("How much chicken is in the main freezer?", ["lot", "medium", "small"])
separate_freezer = st.radio("Is the separate freezer stocked with chicken?", ["yes", "no"])

if separate_freezer == "no":
    chicken_order = 10
elif chicken_freezer == "lot":
    chicken_order = 25
elif chicken_freezer == "small":
    chicken_order = 35
else:
    chicken_order = 30
